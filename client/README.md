...
![Design preview for the Product feedback app coding challenge](../../Downloads/product-feedback-app/preview.jpg)
...
We strongly recommend overwriting this `README.md` with a custom one. We've provided a template inside the [`README-template.md`](../../Downloads/product-feedback-app/README-template.md) file in this starter code.
